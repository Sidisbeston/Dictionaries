...
FINAL_LEVEL = 6
START_SPEED = 10
ITEMS = ["plastic_bag","battery","bottle","chips"]
...
def get_option_to_create(number_of_extra_items):
    items_to_create = ["/Users/siddharth/Desktop/jetlearn coding/GameDev_1/images/paper_bag.png"]
